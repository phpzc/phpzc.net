                                ...
                                <form class="form-horizontal" role="form" action="/user/accountBindNew" method="post">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10 has-success">
                                            <input type="text" class="form-control" id="inputName1" placeholder="Name" name="name" value="{{ $username ?? '' }}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 has-success">
                                            <img src='{{ $avatar_img ?? CUBE('/img/samples/scarlet-159.png') }}' id="inputAvatar" width=80 height=80/>
                                        </div>
                                    </div>
