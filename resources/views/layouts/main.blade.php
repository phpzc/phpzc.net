...
<head>
    ...
    <title>{{ $website_title ?? '' }}  - {{ $WEBSITE['name'] }}</title>
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">
                                ...
                                <ul class="submenu">
                                    <li>
                                        ...
                                        @foreach($WebsiteCategory as $v)
                                            <a href="/article/search?category={{ $v['id'] ?? '' }}" title="Articles——{{ $v['name'] ?? '' }}"
                                         ...
                                         @foreach($project_data['summary'] as $summary_data)
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <?php foreach ($summary_data['sub_data'] as $article_data){ ?>
                                                    ...
                                                    <li >
                                                        <a href="/project/detail?id={{ $article_data['id'] ?? '' }}" class='@if ($this_id == $article_data['id']) active @endif' >
                                                            {{ $article_data['title'] }}
                                                        </a>
                                                    </li>
                                                 <?php } ?>
                            ...
                            <!-- nginx源码注释 -->
                                ...
                                @foreach($WebsiteCacheNginx as $cache_nginx_code)
                                    ...
                                    <a href="#" class="dropdown-toggle" >
                                        <i class="fa fa-file-text"></i>
                                        <span>{{ $cache_nginx_code['name'] ?? '' }}</span>
                                        <i class="fa fa-angle-right drop-icon"></i>
