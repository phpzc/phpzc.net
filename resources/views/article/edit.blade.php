...
@section('content')
    ...
    <div class="row">
        <div class="container">
            <div class="row">
                <form class="card"  action="/article/update" method="post" id="current_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <script id="myEditor" name="form_article" type="text/plain" style="height:200px;">{{!!$article['content']!!}}</script>
